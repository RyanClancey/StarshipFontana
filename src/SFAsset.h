 ...
 */
enum SFASSETTYPE {SFASSET_DEAD, SFASSET_PLAYER, SFASSET_PROJECTILE, SFASSET_COIN, SFASSET_ALIEN, SFASSET_ALIEN2, SFASSET_WALL, SFASSET_TOKEN};
...
public:
  ...
  virtual void      GoEastA();
  virtual void      GoWestA();
